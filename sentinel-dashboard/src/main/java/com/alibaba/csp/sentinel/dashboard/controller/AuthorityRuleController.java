...
public class AuthorityRuleController {
    ...
    private final DynamicRuleProvider<List<AuthorityRuleEntity>> authorityRuleNacosProvider;
    private final DynamicRulePublisher<List<AuthorityRuleEntity>> authorityRuleNacosPublisher;

    public AuthorityRuleController(DynamicRuleProvider<List<AuthorityRuleEntity>> authorityRuleNacosProvider,
                                   DynamicRulePublisher<List<AuthorityRuleEntity>> authorityRuleNacosPublisher) {
        this.authorityRuleNacosProvider = authorityRuleNacosProvider;
        this.authorityRuleNacosPublisher = authorityRuleNacosPublisher;
    }
...
//            List<AuthorityRuleEntity> rules = sentinelApiClient.fetchAuthorityRulesOfMachine(app, ip, port);
            List<AuthorityRuleEntity> rules = this.authorityRuleNacosProvider.getRules(app, ip, port);
...
//        }
        try {
            ...
            logger.info("delete authority rules failed after rule delete");
        }
